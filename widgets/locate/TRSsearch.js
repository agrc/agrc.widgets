...
dojo.declare("agrc.widgets.locate.TRSsearch", [dijit._Widget, dijit._Templated], {
	...
	_rangeQueryUrl: "//mapserv.utah.gov/WSUT/GetFeatureAttributes.svc/trssearch-widget/layer(SGID93.CADASTRE.PLSS_TR_Lookup)returnAttributes(PairsWith)where(TorRName)(=)({0})?dojo",
	...
	_sectionQueryUrl: "//mapserv.utah.gov/WSUT/GetFeatureAttributes.svc/trssearch-widget/layer(SGID93.CADASTRE.PLSS_Sec_Lookup)returnAttributes(PairsWith)where(TRName)(=)({0})?dojo",
